...
int main()
{
  ...
  cout << "Masukkan data yang ingin anda masukkan: " << endl;
  cin >> n;
  double data_xy[n];
  ...
  {
    Data data;
    cout << "Masukkan data X ke-" << i + 1 << " : " << endl;
    cin >> dta[i].data_x;
    while (dta[i].data_x <= 0) {
            cout << "Nilai x tidak boleh kurang dari 0, Masukkan Nilai x: "<< endl;
            cin >> dta[i].data_x;
    }
    cout << "Masukkan data Y ke-" << i + 1 << " : " << endl;
    cin >> dta[i].data_y;
    while (dta[i].data_y <= 0) {
            cout << "Nilai y tidak boleh kurang dari 0, Masukkan Nilai y: " << endl;
            cin >> dta[i].data_y;
    }
